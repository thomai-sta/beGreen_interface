...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" 
	...
	$(document).ready(function(){
		$(".employees").hover(function() {
			$(this).attr("src","eikones/employees1.png");
				}, function() {
			$(this).attr("src","eikones/employees.png");
		});
	});
	</script>
	<script type='text/javascript'>
	...
	$(document).ready(function(){
		$(".recyclers").hover(function() {
			$(this).attr("src","eikones/recyclers.png");
				}, function() {
			$(this).attr("src","eikones/employees.png");
		});
	});
	...
	$(document).ready(function(){
		$(".insert").hover(function() {
			$(this).attr("src","eikones/add_user1.png");
				}, function() {
			$(this).attr("src","eikones/add_user.png");
		});
	});
	</script>
	<script>
	function editEmployee(key){
	   ...
	   var checkout_date = list[0].innerHTML;
	   var occupation = list[1].innerHTML;
	   var contract = list[2].innerHTML;
	   var comment = list[3].innerHTML;
	   var salary = list[4].innerHTML;
	   
	   window.location.href = "edit_employee.php?checkout_date=" + checkout_date + "&occupation=" + occupation + "&contract=" + contract + "&comment=" + comment + "&salary=" + salary + "&workerid=" + key +"&action=deleteVarBySup";
	}
	</script>
    ...
    <body>
        <div class="universe">
			...
			<FORM action="my_employees.php" method="post">
			<INPUT TYPE="image" VALUE="employees" src="eikones/employees.png" class="employees">
			</FORM>
			<FORM action="recyclers.php" method="post">
			<INPUT TYPE="image" VALUE="recyclers" src="eikones/employees.png" class="recyclers">
			</FORM>
